...
* **Depth perception:** Simple shading was implemented, multiplying the color of each face by a coefficient determined by the ratio of the angle of the normal vector to the camera's forward vector.
